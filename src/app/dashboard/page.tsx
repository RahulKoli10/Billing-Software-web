  ...
  if (!subscription)
    return (
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 mb-6 max-w-xs">You currently don't have an active plan. Choose a plan to start using the software.</p>
        <a
          href="/plans-price"
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl text-black font-bold font-headline tracking-tighter">Dashboard Overview</h2>
          <p className="text-gray-500 font-medium">Real-time status of your software protocol subscription.</p>
        </div>
        ...
        {stats.map((stat) => (
          <Card key={stat.title} className="relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500 cursor-pointer">
            <div className="flex justify-between items-start mb-4">
              ...
              <Badge variant={stat.trend as any}>{stat.change}</Badge>
            </div>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-50">
                  <tr className="group hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="py-4 font-mono text-xs font-bold text-blue-600 truncate max-w-[120px]" title={subscription.license_key}>
            ...
            <Card title="Software Credentials" subtitle="Authentication details for your client binary">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                  <p className="text-[10px] uppercase font-black tracking-widest text-gray-400 mb-1">Software Username</p>
                ...
                <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 flex flex-col justify-center relative">
                  <p className="text-[10px] uppercase font-black tracking-widest text-blue-400 mb-1">Software Password</p>
                  <div className="flex justify-between items-center">
                    {plainPassword ? (
                      <div className="flex items-center gap-3">
        ...
        <div className="space-y-6">
          <Card title="Direct Actions" subtitle="High-priority system tasks">
            <div className="space-y-3">
              ...
              >
                <div>
                  <p className="text-sm font-bold text-gray-900">Download Invoice</p>
                  <p className="text-xs text-gray-500 italic">Latest payment receipt</p>
                </div>
                <ArrowUpRight className="w-4 h-4 text-blue-600 opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all" />
              </button>
            </div>
          ...
          <div className="p-6 rounded-2xl bg-linear-to-br from-blue-600 to-blue-800 text-white shadow-xl shadow-blue-600/20 relative overflow-hidden">
            <div className="relative z-10">
              <p className="text-[10px] uppercase font-black tracking-[0.2em] opacity-80 mb-2">Protocol Status</p>
              <h4 className="text-lg font-black font-headline leading-tight mb-4">
