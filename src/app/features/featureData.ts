...
"Designed as an easy GST billing software for beginners, BissBill requires zero accounting knowledge to get started. Use barcode scanning for faster checkout, duplicate previous invoices to save time, and pick from custom templates that reflect your brand. Once done, share invoices instantly via WhatsApp, SMS, or Email — directly from the app. If you're looking for a smart Tally alternative billing software for India, BissBill is built exactly for you."
  ...
  },
  {
    ...
    cardDescription:
      "Track your stock in real-time with India's smartest billing software with inventory. Get low stock alerts before you run out never lose a sale again.",
    detailParagraphs: [
  ...
  },
  {
    ...
    cardDescription:
      "Auto-calculate CGST, SGST & IGST on every invoice. Stay 100% GST-compliant with India's most reliable online GST billing software zero manual effort.",
    detailParagraphs: [
  ...
  },
  {
    ...
    cardDescription:
      "Get a clear picture of your business performance with smart sales reports and a real-time dashboard built into your GST billing software.",
    detailParagraphs: [
  ...
  },
  {
    ...
    cardDescription:
      "Faster checkout, fewer errors. BissBill POS billing software for retail shops lets you scan, bill, and collect payment in seconds — right at the counter.",
    detailParagraphs: [
  ...
  },
  {
    ...
    cardDescription:
      "Control who sees what in your business. BissBill lets you set role-based access for every team member — keeping your data safe and your operations organised.",
    detailParagraphs: [
  ...
  },
  {
    ...
    title: "Multi-Store & Branch Management",
    cardDescription:
      "Running more than one shop? Manage all your branches, stock, and sales from a single BissBill account — India's smartest billing software for growing businesses.",
    detailParagraphs: [
  ...
  },
  {
    ...
    cardDescription:
      "Record every purchase and expense in one place. BissBill keeps your costs organised so you always know where your money is going.",
    detailParagraphs: [
  ...
  },
  {
    ...
    cardDescription:
      "Track every rupee received and every due payment outstanding. BissBill makes payment collection simple, fast, and completely organised for Indian businesses.",
    detailParagraphs: [
